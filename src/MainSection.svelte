...
<section class="wrapper p-8 h-full">
	<div>
		<img
			src="heart2.png"
			id="heart_img"
			class="h-auto fade-in-left"
...
<style>
	...
	@keyframes fadein-left {
		from {
			opacity: 0;
			transform: translate3d(10%, 5%, 0) rotate(-20deg);
		}

		to {
			opacity: 1;
			transform: translate3d(40%, 5%, 0) rotate(-20deg);
		}
	}
